    ...
    private void drawSlot(Slot slotIn)
    {
        ...
        if (!flag1)
        {
            ...
            if(slotIn.getHasStack())
            	stacksize = slotIn.getStack().stackSize;
            ...
            if(stacksize > 999 && stacksize < 10000)
            {
            	...
            	this.itemRender.renderItemOverlayIntoGUI(this.fontRendererObj, itemstack, i, j, formattedString + "k");            	
            }
            else if(stacksize >= 10000)
            {
            	this.itemRender.renderItemOverlayIntoGUI(this.fontRendererObj, itemstack, i, j, stacksize/1000 + "k");             	
            }
            else
            {
